            ...
            for rows in csv_reader:
                ...
                if(old_analysis == False):
                    data = {
                        ...
                        'Human_accessibility': {
                            'image_metadata': utils.parse_score_details(rows.get('Image Metadata', '')),
                            'image' :  utils.parse_score_details(rows.get('Image', '')),
                            'audio_metadata' : utils.parse_score_details(rows.get('Audio metadata', '')),
                            'audio' : utils.parse_score_details(rows.get('Audio', '')),
                            'video_metadata' : utils.parse_score_details(rows.get('Video metadata', '')),
                            'video' : utils.parse_score_details(rows.get('Video', '')),
                            'metadata_language' : utils.parse_score_details(rows.get('Metadata Lang', '')),
                            'data_language' : utils.parse_score_details(rows.get('Data Lang', '')),
                            'labels' : utils.parse_score_details(rows.get('Labels', '')),
                            'examples' : utils.parse_score_details(rows.get('Examples', '')),
                            'description_readability' : utils.parse_score_details(rows.get('Description Readability', '')),
                            'contact_person' : utils.parse_score_details(rows.get('Contact person', '')),
                            'dump_size' : utils.parse_score_details(rows.get('Dump size', '')),
                            'auth' : utils.parse_score_details(rows.get('Auth', '')),
                            'dump_format' : utils.parse_score_details(rows.get('Dump format', '')),
                            'open_license' : utils.parse_score_details(rows.get('Open License', '')),
                            'alternative_access_points' : utils.parse_score_details(rows.get('Alternative access points', '')),
                            'versioning' : utils.parse_score_details(rows.get('Versioning', '')),
                            'robots_txt' : utils.parse_score_details(rows.get('robots_txt', '')),
                            'webpage_broken_links' : utils.parse_score_details(rows.get('Webpage broken link', '')),
                            'broken_metadata_link_rate' : utils.parse_score_details(rows.get('Broken metadata link rate', '')),
                            'canonical_id' : utils.parse_score_details(rows.get('Canonical ID', '')),
                            'alt' : utils.parse_score_details(rows.get('Alt', '')),
                            'audio_description' : utils.parse_score_details(rows.get('Audio description', '')),
                            'video_description' : utils.parse_score_details(rows.get('Video description', '')),
                            'signLang_video' : utils.parse_score_details(rows.get('signLang_video', '')),
                            'signLang_audio' : utils.parse_score_details(rows.get('signLang_audio', '')),
                            'captions_video': utils.parse_score_details(rows.get('captions_video', '')),
                            'captions_audio' : utils.parse_score_details(rows.get('captions_audio', '')),
                            'transcript_video' : utils.parse_score_details(rows.get('transcript_video', '')),
                            'transcript_audio' : utils.parse_score_details(rows.get('transcript_audio', '')),
                            'perceivable_score' : rows.get('Perceivable score', ''),
                            'operable_score' : rows.get('Operable score', ''),
                            'understandable_score' : rows.get('Understandable score', ''),
                            'robust_score' : rows.get('Robust score', ''),
                            'accessibility_for_visual_imp_score' : rows.get('Accessibility for visually impaired score', ''),
                            'accessibility_for_def_hearing_imp_score' : rows.get('Accessibility for deaf and hearing score', ''),
                            'human_acc_score_no_special' : rows.get('Human-centered accessibility overall score (no special needs)', ''),
                            'human_acc_score_with_special' : rows.get('Human-centered accessibility overall score (with special needs)', ''),
                            'human_acc_score_only_special' : rows.get('Human-centered accessibility overall score (only special needs)', ''),
                        }
                    }
                else:
                    data = {
