                ...
                if(old_analysis == False):
                    data = {
                        ...
                        'Human_accessibility': {
                            ...
                            'audio' : rows.get('Audio', ''),
                            'video_metadata' : rows.get('Video metadata', ''),
                            'video' : rows.get('Video', ''),
                            'metadata_language' : rows.get('Metadata Lang', ''),
                            'data_language' : rows.get('Data Lang', ''),
                            'labels' : rows.get('Labels', ''),
                            'examples' : rows.get('Examples', ''),
                            'description_readability' : rows.get('Description Readability', ''),
                            'contact_person' : rows.get('Contact person', ''),
                            'dump_size' : rows.get('Dump size', ''),
                            'auth' : rows.get('Auth', ''),
                            'dump_format' : rows.get('Dump format', ''),
                            'open_license' : rows.get('Open License', ''),
                            'alternative_access_points' : rows.get('Alternative access points', ''),
                            'versioning' : rows.get('Versioning', ''),
                            'robots_txt' : rows.get('robots_txt', ''),
                            'webpage_broken_links' : rows.get('Webpage broken link', ''),
                            'broken_metadata_link_rate' : rows.get('Broken metadata link rate', ''),
                            'canonical_id' : rows.get('Canonical ID', ''),
                            'alt' : rows.get('Alt', ''),
                            'audio_description' : rows.get('Audio description', ''),
                            'video_description' : rows.get('Video description', ''),
                            'signLang_video' : rows.get('signLang_video', ''),
                            'signLang_audio' : rows.get('signLang_audio', ''),
                            'captions_video': rows.get('captions_video', ''),
                            'captions_audio' : rows.get('captions_audio', ''),
                            'transcript_video' : rows.get('transcript_video', ''),
                            'transcript_audio' : rows.get('transcript_audio', ''),
